...
from disparity.methods import Config, StereoMethod, IntParameter, EnumParameter, InputPair, StereoOutput
...
class StereoBM(StereoMethod):
    ...
    def reset_defaults(self):
        ...
        self.parameters.update({
            ...
            "SpeckleWindowSize": IntParameter("Speckle window size in pixels (filter small objects). 0 to disable.",
                                              100, 0, 1000),
    ...
    def compute_disparity(self, input: InputPair) -> StereoOutput:
        ...
        if len(left_image.shape) == 2:
            gray_left = left_image.copy()
            gray_right = right_image.copy()
        else:
...
class StereoSGBM(StereoMethod):
    ...
    def reset_defaults(self):
        ...
        self.parameters.update({
            ...
            "P2": IntParameter("Penalty Cost. Must be > P1 (default=32*NChannels*BlockSize).", 32 * nchannels * 3 * 3,
                               0, 2000),
