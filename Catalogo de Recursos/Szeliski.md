...
((Leer [[Szeliski#11]] para entender el cálculo de las posiciones ed cámaras y una reconstrucción poco densa de escenas)).
...
Los algoritmos de matcheo originales usaban extracción de características. Primero se determinaban puntos de interés en las imágenes que puedan ser usados para d
