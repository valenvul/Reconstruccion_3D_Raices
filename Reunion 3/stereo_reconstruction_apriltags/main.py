...
for left_file_name, right_file_name in zip(
        ...
        # with apriltags
        left_object_points, left_image_points = detect_apriltags(left_image_rectified, tag_size_mm, left_K, left_dist)
        right_object_points, right_image_points = detect_apriltags(right_image_rectified, tag_size_mm, right_K,right_dist)
